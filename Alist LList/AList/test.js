    ...
    describe(name, function () {
        testData.forEach(function (data) {
            ...
            it(`should contain expected data: ${expEls}`, function () {
                assert.deepEqual(arr.arr, expEls, `actual elements = ${arr.arr}`);
            })
        });
    });
}
    ...
    describe(name, function () {
        testData.forEach(function (data) {
            ...
            it(`should contain elements ${expEls}`, function () {
                assert.deepEqual(arr.arr, expEls);
            });
...
describe('remove', function () {
    ...
    it(`should delete single element`, function () {
        ...
        assert.strictEqual(arr.arr[0], void 0)
    });
    ...
    it(`should delete one element`, function () {
        ...
        assert.strictEqual(arr.arr[0], 5);
        assert.strictEqual(arr.arr[1], undefined)
    });
    ...
    it(`should delete one element`, function () {
        ...
        assert.strictEqual(arr.length, 1);
        assert.strictEqual(arr.arr[0], 10);
        assert.isUndefined(arr.arr[1]);
    });
    ...
    it(`should delete one element`, function () {
        ...
        assert.strictEqual(arr.arr[0], 10);
        assert.strictEqual(arr.arr[1], 40);
        assert.isUndefined(arr.arr[2])
    })
});
...
describe('splice', function () {
    ...
    testData.forEach(function (data) {
        ...
        it(`should delete elements or add new ones. given data: ${init}, args: ${args}`, function () {
            ...
            assert.deepEqual(arr.arr, expContent, `resulting data was expected to be ${arr.arr}, actual: ${expContent}`);
        })
    })
});